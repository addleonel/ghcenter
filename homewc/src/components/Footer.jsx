    ...
    <React.Fragment>
      <div className="home-footer">
        ...
        <div>
          ...
          <p className="home-footer__p"><FontAwesomeIcon icon="fa-solid fa-location-dot" /> Huallayco - Huánuco #1251 Huánuco, Peru</p>
        </div>
    </div>
    {/* <img className="redwoman" src="" /> */}
    <p className="home-footer__copyright">
      2022 © Granitos Home center - Reservados todos los derechos
    </p>
    </React.Fragment>
  );
}
